    ...
    <>
      <section className="flex flex-col gap-8 py-10">
        <div className="flex justify-between items-center pb-2 border-b">
          <h2 className="text-sm uppercase tracking-wide text-content-hint">Testimonials</h2>
        ...
        <div className="embla overflow-hidden" ref={emblaRef}>
          <div className="embla__container flex mr-4">
            {testimonials.map((testimonial, i) => (
              <div className="embla__slide flex-none basis-full md:basis-1/2 lg:basis-2/5 mr-4" key={i}>
